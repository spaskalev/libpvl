...
void test_pvl_init_initial_load_error_01() {
...
void test_pvl_init_initial_load_error_02() {
    printf("\n[test_pvl_init_initial_load_error_02]\n");
...
void test_pvl_init_initial_load_error_03() {
    printf("\n[test_pvl_init_initial_load_error_02]\n");
    int written_length = 96;
    int marks_count = 10;
    ...
    ctx.post_load[1].return_int = 1;
    ctx.post_load[1].expected_pvl = ctx.pvl;
    ctx.post_load[1].expected_file = load_src;
    ctx.post_load[1].expected_failed = 0;
    ctx.post_load[1].expected_last_good = 16;

    ctx.post_load[2].return_int = 0;
    ctx.post_load[2].expected_pvl = ctx.pvl;
    ctx.post_load[2].expected_file = ctx.dyn_file;
    ctx.post_load[2].expected_failed = 0;
    ctx.post_load[2].expected_last_good = 96;
...
void test_pvl_init_initial_load_error_04() {
    printf("\n[test_pvl_init_initial_load_error_02]\n");
    int written_length = 96;
    int marks_count = 10;
...
int main() {
    ...
    test_pvl_init_initial_load_error_01();
    test_pvl_init_initial_load_error_02();
    test_pvl_init_initial_load_error_03();
    test_pvl_init_initial_load_error_04();
